...
while ($i < $num) {
  ...
  $query0="SELECT hashrate,confirmed_reward FROM slush_pool_results_archive WHERE api_key='$api_key' AND worker_name='$worker_name' AND creation_time BETWEEN DATE_SUB(CURDATE(), INTERVAL 1 DAY) AND CURDATE();";
  mysql_query($query0);
  ...
  $query1="SELECT hashrate,confirmed_reward FROM slush_pool_results_archive WHERE api_key='$api_key' AND worker_name='$worker_name' AND creation_time BETWEEN DATE_SUB(CURDATE(), INTERVAL 7 DAY) AND CURDATE();";
  mysql_query($query1);
